...
require_once('objetivos_form.php');
...
$activityform = new newactivity_form();
$toform['idinstance'] = $idinstance;
$toform['courseid'] = $courseid;
$toform['idind'] = $id;
$activityform->set_data($toform);
...
if ($activityform->is_cancelled()) {
...
} else if ($fromform = $activityform->get_data()) {
 ...
 //$contextmodule = context_module::instance($idinstance);
    ...
    $lastinsertid=$DB->insert_record('induction_objetivo', $fromform);
