...
require_once('function_form.php');
...
if ($functionform->is_cancelled()) {
 ...
 //$contextmodule = context_module::instance($idinstance);
    ...
    $lastinsertid=$DB->insert_record('induction_functions', $fromform);
