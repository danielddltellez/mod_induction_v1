...
if ($areaform->is_cancelled()) {
 ...
 //$contextmodule = context_module::instance($idinstance);
    ...
    $lastinsertid=$DB->insert_record('induction_area', $fromform);
